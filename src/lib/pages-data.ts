...
export const navigationPages: PageData[] = [
  {
    ...
    description: "A Império Gás e Água é referência em disk gás em Pelotas RS. Oferecemos entrega rápida de botijão P13 Liquigás 13kg para residências, P08 8kg para pequenos comércios, Liquinho 2kg portátil para fogareiro e camping, além de galão de água mineral 20 litros para residências, escritórios e empresas em todos os bairros de Pelotas. Funcionamos todos os dias das 09h às 22:30h, com pedidos pelo WhatsApp ou telefone. Conte com a Império para nunca ficar sem gás!",
    schemaType: "Service",
    faqs: [
      ...
      { q: "O disk gás da Império atende em feriados?", a: "Sim! Nosso serviço de disk gás funciona todos os dias, incluindo feriados e finais de semana, das 09h às 22:30h." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Vocês entregam gás à noite em Pelotas?", a: "Sim! Nosso horário de entrega vai das 09h às 22:30h, todos os dias da semana, incluindo feriados." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "A Império trabalha com qual marca de gás?", a: "Somos Revenda Autorizada em Pelotas, com procedência garantida." },
  ...
  },
  {
    ...
    description: "Precisa de gás ou água mineral em Pelotas? Entre em contato com a Império Gás e Água! Atendemos pelo WhatsApp, telefone fixo e celular. Nosso horário de funcionamento é todos os dias das 09h às 22:30h. Faça seu pedido agora e receba com entrega rápida na sua porta.",
    ...
    faqs: [
      ...
      { q: "Qual o telefone fixo da Império Gás?", a: "Nosso telefone fixo é (53) 3273-9559. Atendemos das 09h às 22:30h todos os dias." },
...
export const productPages: PageData[] = [
  ...
  },
  {
    ...
    description: "O botijão P08 (8kg) é a escolha ideal para pequenos comércios, food trucks, trailers de lanche, lanchonetes e estabelecimentos de baixo consumo em Pelotas RS. Mais leve e prático que o P13, o P08 Liquigás é fácil de transportar e perfeito para quem precisa de gás de cozinha em formato compacto. A Império Gás e Água entrega o P08 com agilidade em todos os bairros de Pelotas, todos os dias das 09h às 22:30h.",
    schemaType: "Product",
    faqs: [
      ...
      { q: "Vocês entregam P08 em todos os bairros de Pelotas?", a: "Sim! Entregamos o botijão P08 Liquigás em todos os bairros de Pelotas RS, todos os dias das 09h às 22:30h, com a mesma agilidade do P13." },
