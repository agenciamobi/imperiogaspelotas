...
const ConversionHero = () => {
  ...
  return (
    <section id="inicio" className="scroll-mt-28 relative overflow-hidden">
      ...
      {/* Decorative blobs */}
      <svg className="absolute top-10 left-[-120px] w-[500px] h-[500px] opacity-20" viewBox="0 0 400 400">
        <circle cx="200" cy="200" r="200" fill="hsl(150 50% 15%)" />
      </svg>
      <svg className="absolute bottom-[-80px] right-[-100px] w-[600px] h-[600px] opacity-15" viewBox="0 0 500 500">
        <circle cx="250" cy="250" r="250" fill="hsl(20 100% 55%)" />
      </svg>
      <svg className="absolute top-[30%] right-[25%] w-[250px] h-[250px] opacity-10" viewBox="0 0 200 200">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] sm:text-[10px] text-[hsl(var(--muted-foreground))]">Online agora</p>
                  </div>
                </div>
                <div className="bg-[hsl(var(--accent))] rounded-lg p-2 mb-1.5">
                  <p className="text-[10px] sm:text-xs text-[hsl(var(--foreground))]">Olá! Quero pedir um botijão P13 🔥</p>
                </div>
                <div className="bg-[hsl(var(--whatsapp))]/10 rounded-lg p-2 ml-4">
                  <p className="text-[10px] sm:text-xs text-[hsl(var(--foreground))]">Perfeito! Entregamos em 30 min ⚡</p>
                </div>
              </motion.div>
