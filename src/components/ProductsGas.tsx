              ...
              itemListElement: [
                {
                  ...
                  item: {
                    "@type": "Product",
                    name: "Botijão de Gás P13 13kg",
                    description: "Botijão de gás de cozinha P13 13kg para uso residencial. O mais pedido em Pelotas RS, com entrega rápida pelo WhatsApp.",
                    brand: { "@type": "Brand", name: "Império Gás e Água" },
